...
public class JdbcLookupOptions implements Serializable {
	...
	public JdbcLookupOptions(long cacheMaxSize, long cacheExpireMs, int maxRetryTimes, String resetCron) {
	...
	public boolean equals(Object o) {
		if (o instanceof JdbcLookupOptions) {
			...
			return Objects.equals(cacheMaxSize, options.cacheMaxSize) &&
				...
				Objects.equals(resetCron, options.resetCron);
		} else {
			return false;
		}
	}
	...
	public static class Builder {
		...
		public Builder setResetCron(String cronStr) {
			this.resetCron = cronStr;
			return this;
		}

		public JdbcLookupOptions build() {
			return new JdbcLookupOptions(cacheMaxSize, cacheExpireMs, maxRetryTimes, resetCron);
		}
	}
}
